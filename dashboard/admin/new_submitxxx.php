	...
	<body>
		<header>
			...
			<address>
				...
				<p>Landline:+63347090076</p><p>www.goldgym.com (goldgym@gmail.com)</p><br><p><div id="barcodeTarget" class="barcodeTarget"></div>
    <canvas id="canvasTarget"></canvas> </span>
			</address>
			<span><img alt="" src="../../img/logo.jpg">
		</header>
		<article>
			<table class="meta">
...
?></span></td>
		...
		<aside>
			...
			<div  >
				<p>1). All members must abide our TnC / rules otherwise membership may be withdrawn. </br></br>2). The payment is not transferable and non-refundable.</br></br>3).Fee Should be submitted within 5 business days before subjected to expiration, otherwise 100 PHP/Day will be charged.</br></br>4).All users should dress appropriately Or as per advised.</br></br>5).Smoking is NOT permitted at the Gym site.</br></br>6). A PHP 1000 for breaking/scracthing glasses belonging to "Gold's gym" will be imposed.
			</div>
		</aside><center><br><br><a href="view_mem.php">Gold's Gym ( www.samsslimgym.com )</center>
	</body>
</html>